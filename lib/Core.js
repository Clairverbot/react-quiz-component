...
var Core = function Core(_ref) {
  ...
  var renderAnswerInResult = function renderAnswerInResult(question, userInputIndex) {
    ...
    return answers.map(function (answer, index) {
      ...
      }, questionType === 'text' && /*#__PURE__*/_react["default"].createElement("span", null, answer), questionType === 'photo' && /*#__PURE__*/_react["default"].createElement("img", {
        src: answer,
        alt: "image"
      })));
    });
  ...
  var renderQuizResultQuestions = (0, _react.useCallback)(function () {
    ...
    return (filteredQuestions || questions).map(function (question, index) {
      ...
      }), question.questionPic && /*#__PURE__*/_react["default"].createElement("img", {
        src: question.questionPic,
        alt: "image"
      }), renderTags(answerSelectionType, question.correctAnswer.length, question.segment), /*#__PURE__*/_react["default"].createElement("div", {
        className: "result-answer"
      }, renderAnswerInResult(question, userInputIndex)), /*#__PURE__*/_react["default"].createElement(_Explanation["default"], {
        question: question,
        isResultPage: true
      }));
    });
  ...
  var renderAnswers = function renderAnswers(question, buttons) {
    ...
    return answers.map(function (answer, index) {
      return /*#__PURE__*/_react["default"].createElement(_react.Fragment, {
        key: index
      }, buttons[index] !== undefined ? /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
      ...
      }, questionType === 'text' && answer, questionType === 'photo' && /*#__PURE__*/_react["default"].createElement("img", {
        src: answer,
        alt: "image"
      })));
    });
  ...
  var renderTags = function renderTags(answerSelectionType, numberOfSelection, segment) {
    ...
    }, answerSelectionType === 'single' && /*#__PURE__*/_react["default"].createElement("span", {
      className: "single selection-tag"
    }, singleSelectionTagText), answerSelectionType === 'multiple' && /*#__PURE__*/_react["default"].createElement("span", {
      className: "multiple selection-tag"
    }, multipleSelectionTagText), /*#__PURE__*/_react["default"].createElement("span", {
      className: "number-of-selection"
    }, pickNumberOfSelection.replace('<numberOfSelection>', numberOfSelection)), segment && /*#__PURE__*/_react["default"].createElement("span", {
  ...
  var renderResult = function renderResult() {
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: "card-body"
    }, /*#__PURE__*/_react["default"].createElement("h2", null, appLocale.resultPageHeaderText.replace('<correctIndexLength>', correct.length).replace('<questionLength>', questions.length)), /*#__PURE__*/_react["default"].createElement("h2", null, appLocale.resultPagePoint.replace('<correctPoints>', correctPoints).replace('<totalPoints>', totalPoints)), /*#__PURE__*/_react["default"].createElement("br", null), /*#__PURE__*/_react["default"].createElement(_QuizResultFilter["default"], {
  ...
  }, !endQuiz && /*#__PURE__*/_react["default"].createElement("div", {
    className: "questionWrapperBody"
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: "questionModal"
  }, /*#__PURE__*/_react["default"].createElement(_InstantFeedback["default"], {
    question: question,
    showInstantFeedback: showInstantFeedback,
    correctAnswer: correctAnswer,
    incorrectAnswer: incorrectAnswer
  })), /*#__PURE__*/_react["default"].createElement("div", null, appLocale.question, ' ', currentQuestionIndex + 1, ":"), /*#__PURE__*/_react["default"].createElement("h3", {
    dangerouslySetInnerHTML: (0, _helpers.rawMarkup)(question && question.question)
  }), question && question.questionPic && /*#__PURE__*/_react["default"].createElement("img", {
    src: question.questionPic,
    alt: "image"
  }), question && renderTags(answerSelectionTypeState, question.correctAnswer.length, question.segment), question && renderAnswers(question, buttons), (showNextQuestionButton || allowNavigation) && /*#__PURE__*/_react["default"].createElement("div", {
    className: "questionBtnContainer"
  }, allowNavigation && currentQuestionIndex > 0 && /*#__PURE__*/_react["default"].createElement("button", {
    onClick: function onClick() {
      return nextQuestion(currentQuestionIndex - 2);
    },
    className: "prevQuestionBtn btn",
    type: "button"
  }, appLocale.prevQuestionBtn), /*#__PURE__*/_react["default"].createElement("button", {
    onClick: function onClick() {
