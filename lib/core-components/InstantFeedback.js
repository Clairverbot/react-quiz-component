...
var InstantFeedback = function InstantFeedback(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, incorrectAnswer && showInstantFeedback && /*#__PURE__*/_react["default"].createElement("div", {
    className: "alert incorrect"
  }, renderMessageForIncorrectAnswer(question)), correctAnswer && showInstantFeedback && /*#__PURE__*/_react["default"].createElement("div", {
    className: "alert correct"
  }, renderMessageForCorrectAnswer(question), /*#__PURE__*/_react["default"].createElement(_Explanation["default"], {
    question: question,
    isResultPage: false
  })));
};
